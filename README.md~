...
[Correct C++](https://github.com/DaniCrow/correct_cpp) chapter 'Scoreboard'.

## Goal

 * Experience a light version of [how this course works](https://github.com/DaniCrow/correct_cpp/blob/master/doc/how_this_course_works.md)
 ...
 * The link to [Correct C++](https://github.com/DaniCrow/correct_cpp) should still point to `DaniCrow`s version, even in this line :+1:
...
This is [how this course works](https://github.com/DaniCrow/correct_cpp/blob/master/doc/how_this_course_works.md):

  1. Login to [GitHub](https://github.com/)
  2. Fork this repository. See [fork a chapter](https://github.com/DaniCrow/correct_cpp/blob/master/doc/fork_a_chapter.md) for help
  3. Activate Travis CI for your GitHub. See [activate](https://github.com/DaniCrow/correct_cpp/blob/master/doc/activate.md) for help 
  4. Clone your fork. See [clone your fork](https://github.com/DaniCrow/correct_cpp/blob/master/doc/clone_your_fork.md) for help
  5. On your local code, modify this `README.md` file: replace `DaniCrow/correct_cpp_` by `DaniCrow/correct_cpp_`
  6. Push your code. See [push your code](https://github.com/DaniCrow/correct_cpp/blob/master/doc/push_your_code.md) for help
 ...
 * Video how to do this chapter: [mp4](http://www.DaniCrow.nl/correct_cpp_scoreboard.mp4) [YouTube](https://youtu.be/QABP8qEeM9o)
